    ...
    return (
        <Page>
            ...
            <Price
                ...
                chekout={data.availability.checkout_date}
            />
            ...
            <Amenities title="Зручності"
                ...
                transfer={data.amenities.hasAirportShuttle}
            ...
            <Rewiews list={data.guestReviews} />

            <NearbyAttractions title="Пам'ятки поблизу" list={data.nearbyAttractions} />
